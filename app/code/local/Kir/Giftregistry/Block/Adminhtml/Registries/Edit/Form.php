<?php
class Kir_Giftregistry_Block_Adminhtml_Registries_Edit_Form
    extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm(){
        ...
        $fieldset = $form->addFieldset('registry_form',
            array('legend' => Mage::helper('kir_giftregistry')
                ->__('Gift Registry information')));
        $fieldset->addField('type_id', 'text', array(
            'label' => Mage::helper
            ('kir_giftregistry')->__('Registry Id'),
        ...
        $fieldset->addField('website_id', 'text', array(
            'label' => Mage::helper
            ('kir_giftregistry')->__('Website Id'),
            'class' => 'required-entry',
            'required' => true,
            'name' => 'website_id',
        ));
        ...
        ('event_location', 'text', array(
            'label' => Mage::helper
            ('kir_giftregistry')->__('Event Location'),
            'class' => 'required-entry',
            'required' => true,
            'name' => 'event_location',
        ));
        ...
        $fieldset->addField('event_country', 'text', array(
            'label' => Mage::helper
            ('kir_giftregistry')->__('Event Country'),
            'class' => 'required-entry',
            'required' => true,
            'name' => 'event_country',
        ));
        $fieldset->addField('giftregistry_save_button', 'submit', array(
            'label' => Mage::helper
            ('kir_giftregistry')->__('Save'),
            'name' => 'giftregistry_save',
        ));
